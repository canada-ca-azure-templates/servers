...
| customScript              | object  | No       | Object containing Windows custom script extension parameters. [Windows Custom Script Extension Object](#windows-custom-script-extension-object)                                                                                                                                                                                                                                                                                                                                                           |
| DSCSettings               | obkect  | No       | Object containing Windows DSC extension parameters. [Windows DSC Settings Property Object](#dsc-settings-property-object)                                                                                                                                                                                                                                                                                                                                                           |
...
#### Windows Custom Script Extension object

| Name              | Type   | Required | Value                                                                                                                                                                       |
| ----------------- | ------ | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| settings          | object | No       | Object containing windows custom script properties - [Windows Custom Script Extension Settings object](#windows-custom-script-extension-settings-object)                    |
| protectedSettings | object | No       | Object containing windows custom script properties - [Windows Custom Script Extension Protected Settings object](#windows-custom-script-extension-protectedsettings-object) |

[Windows Custom Script Extension reference](https://docs.microsoft.com/en-us/azure/virtual-machines/extensions/custom-script-windows)

##### Windows Custom Script Extension Settings object

| Name             | Type   | Required | Value                                                                                                                                                                           |
| ---------------- | ------ | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| fileUris         | array  | No       | Array of string containing the URLs for file(s) to be downloaded.                                                                                                               |
| timestamp        | int    | No       | Object containing windows custom script properties - [Windows Custom Script Extension Settings object] Configuration properties                                                 |
| commandToExecute | string | no       | can be set in either public (settings) or protected settings, the extension will reject any configuration where the values below are set in both settings and protectedSettings |

##### Windows Custom Script Extension ProtectedSettings object

| Name               | Type   | Required | Value                                                                                                                                                                           |
| ------------------ | ------ | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| commandToExecute   | string | no       | Can be set in either public (settings) or protected settings, the extension will reject any configuration where the values below are set in both settings and protectedSettings |
| storageAccountName | string | No       | The name of storage account. If you specify storage credentials, all fileUris must be URLs for Azure Blobs.                                                                     |
| storageAccountKey  | string | no       | The access key of storage account                                                                                                                                               |
...
|          |                                                                                | Update how Private IP is made static through new find/replace custom function that will allow to find and replace within any objects in the future                                                                                                                                                                                                                                                                                           |  | 20190610 | [20190610](https://github.com/canada-ca-azure-templates/servers/tree/20190610) | Updated antimalware version |
| 20190611 | [20190611](https://github.com/canada-ca-azure-templates/servers/tree/20190611) | Add dupport for optional Windows Custom Script                                                                                                                                                                                                                                                                                                                                                                                               |
